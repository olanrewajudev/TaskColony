        ...
        <Layout>
            <div className="bg-gray w-full xl:h-[10rem]">
                <div className="text-center py-1 pt-10">
                    <p className='font-[500] text-4xl mb-3'>Terms & Conditions</p>
            ...
            <div className="lg:mx-28 mx-2 text-justify my-20">
                ...
                <div className="my-8">
                    <h1 className="text-xl font-medium mb-4">Electronic Communications</h1>
                    <p>
                        By creating an account with TaskColony, whether as a User or Service Provider, you consent to receive communications from us electronically. These communications may include but are not limited to:
                    </p>
                    <ul  className="list-disc ml-6 font-medium mt-3 space-y-2">
                        <li>Transactional and service-related messages (e.g., job confirmations, booking updates, account notifications)</li>
                        <li>Promotional messages (if you have opted in)</li>
                        <li>Administrative communications (e.g., changes to our terms, service alerts, policy updates)</li>
                    </ul>
                    <p className="mt-3">
                        You agree that we may contact you via email, SMS/text messages, and, in some cases, phone calls to the contact information you provide upon registration or update in your account.                    </p>
                    <p className="mt-3">
                        By providing your phone number, you consent to receive automated text messages and calls for the purposes of facilitating services, verifying identity, providing support, and communicating updates relevant to your use of the TaskColony platform.

                    </p>
                    <p className="mt-3">
                        Standard message and data rates may apply. You may opt out of non-essential communications at any time by following the unsubscribe instructions included in our messages or by updating your preferences in your account settings.
                    </p>
                    <p className="mt-3">
                        However, opting out of certain essential communications may impact your ability to use the platform effectively or access certain features.
                    </p>
                </div>
                <div className="mb-8">
                    ...
                    <p>
                        ...
                        other person or entity. You acknowledge that Taskcolony is not responsible for third party access to your
                        account that results from theft or misappropriation of your account. Taskcolony and its associates reserve
                ...
                <div className="mb-8">
                    ...
                    <p>
                        ...
                        thereof, and any software used on the Site, is the property of Taskcolony or its suppliers and protected by
                        copyright and other laws that protect intellectual property and proprietary rights. You agree to observe
                        and abide by all copyright and other proprietary notices, legends or other restrictions contained in any
                    ...
                    <p>
                        ...
                        works, or in any way exploit any of the content, in whole or in part, found on the Site. Taskcolony content is
                        not for resale. Your use of the Site does not entitle you to make any unauthorized use of any protected
                        ...
                        content without the express written permission of Taskcolony and the copyright owner. You agree that you
                        do not acquire any ownership rights in any protected content. We do not grant you any licenses, express or
                        implied, to the intellectual property of Taskcolony or our licensors except as expressly authorized by these
                        Terms.

                    </p>
                </div>
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Use of Communication Services</h4>
                    <p>The Site may contain bulletin board services, chat areas, news groups, forums, communities, personal web
                        pages, calendars, and/or other message or communication facilities designed to enable you to
                        communicate with the public at large or with a group (collectively, "Communication Services"). You agree
                        to use the Communication Services only to post, send and receive messages and material that are proper
                    ...
                    <p className="my-5">
                        ...
                        publicity) unless you own or control the rights thereto or have received all necessary consents; upload files
                        that contain viruses, corrupted files, or any other similar software or programs that may damage the
                        ...
                        or labels of the origin or source of software or other material contained in a file that is uploaded; restrict or
                        inhibit any other user from using and enjoying the Communication Services; violate any code of conduct or
                        other guidelines which may be applicable for any particular Communication Service; harvest or otherwise
                        collect information about others, including e-mail addresses, without their consent; violate any applicable
                        laws or regulations.
                    </p>
                    <p className="mt-5">Taskcolony has no obligation to monitor the Communication Services. However, Taskcolony reserves the
                        right to review materials posted to a Communication Service and to remove any materials in its sole
                        discretion. Taskcolony reserves the right to terminate your access to any or all of the Communication
                        Services at any time without notice for any reason whatsoever.
                    </p>
                    <p className="my-5">
                        Taskcolony reserves the right at all times to disclose any information as necessary to satisfy any applicable
                        law, regulation, legal process or governmental request, or to edit, refuse to post or to remove any
                        information or materials, in whole or in part, in Taskcolony's sole discretion.
                    </p>
                    <p className="">
                        Always use caution when giving out any personally identifying information about yourself or your children
                        in any Communication Service. Taskcolony does not control or endorse the content, messages or
                        information found in any Communication Service and, therefore, Taskcolony specifically disclaims any
                        liability with regard to the Communication Services and any actions resulting from your participation in
                        any Communication Service. Managers and hosts are not authorized Taskcolony spokespersons, and their
                        views do not necessarily reflect those of Taskcolony
                    </p>
                    <p className="">
                ...
                <div className="mb-8">
                    ...
                    <p className='my-5'>No compensation will be paid with respect to the use of your Submission, as provided herein. Taskcolony is
                        under no obligation to post or use any Submission you may provide and may remove any Submission at
                        any time in Taskcolony's sole discretion.
                    </p>
                    <p>By posting, uploading, inputting, providing or submitting your Submission you warrant and represent that
                ...
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Third Party Accounts</h4>
                    <p>
                        You will be able to connect your Taskcolony account to third party accounts. By connecting your
                        Taskcolony account to your third party account, you acknowledge and agree that you are consenting to the
                        continuous release of information about you to others (in accordance with your privacy settings on those
                        third party sites). If you do not want information about you to be shared in this manner, do not use this
                        feature.

                    </p>
                </div>
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">International Users</h4>
                    <p>
                ...
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Indemnification</h4>
                    <p>
                        You agree to indemnify, defend and hold harmless Taskcolony, its officers, directors, employees, agents
                        ...
                        violation of any applicable laws, rules or regulations. Taskcolony reserves the right, at its own cost, to
                        assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in
                        which event you will fully cooperate with Taskcolony in asserting any available defenses.

                    </p>
                </div>
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Arbitration</h4>
                    <p>
                ...
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Class Action Waiver</h4>
                    <p>
                        Any arbitration under these Terms and Conditions will take place on an individual basis; class arbitrations
                        and class/representative/collective actions are not permitted. THE PARTIES AGREE THAT A PARTY MAY
                        BRING CLAIMS AGAINST THE OTHER ONLY IN EACH'S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR
                        CLASS MEMBER IN ANY PUTATIVE CLASS, COLLECTIVE AND/ OR REPRESENTATIVE PROCEEDING, SUCH AS
                        IN THE FORM OF A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless both you
                        and Taskcolony agree otherwise, the arbitrator may not consolidate more than one person's claims, and
                ...
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Liability Disclaimer</h4>
                    <p>
                        ...
                        TO THE INFORMATION HEREIN. TASKCOLONY AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
                        CHANGES IN THE SITE AT ANY TIME.

                    </p>
                    <p className='my-5'>TASKCOLONY AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY, RELIABILITY,
                        ...
                        TASKCOLONY AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES AND CONDITIONS WITH
                        REGARD TO THIS INFORMATION, SOFTWARE, PRODUCTS, SERVICES AND RELATED GRAPHICS, INCLUDING
                        ALL IMPLIED WARRANTIES OR CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
                        PURPOSE, TITLE AND NON-INFRINGEMENT</p>
                    <p>
                        TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL TASKCOLONY AND/OR
                        ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, CONSEQUENTIAL
                        DAMAGES OR ANY DAMAGES WHATSOEVER INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF
                        USE, DATA OR PROFITS, ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OR PERFORMANCE
                        ...
                        RELATED GRAPHICS OBTAINED THROUGH THE SITE, OR OTHERWISE ARISING OUT OF THE USE OF THE
                        SITE, WHETHER BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF
                        TASKCOLONY OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY OF DAMAGES. BECAUSE
                        ...
                        DISSATISFIED WITH ANY PORTION OF THE SITE, OR WITH ANY OF THESE TERMS OF USE, YOUR SOLE AND
                        EXCLUSIVE REMEDY IS TO DISCONTINUE USING THE SITE.
                    </p>
                </div>
                <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-2">Termination/Access Restriction                    </h4>
                    <p>
                        Taskcolony reserves the right, in its sole discretion, to terminate your access to the Site and the related
                        ...
                        jurisdiction and venue of courts in Texas in all disputes arising out of or relating to the use of the Site. Use
                        of the Site is unauthorized in any jurisdiction that does not give effect to all provisions of these Terms,
                    ...
                    <p className='my-5'>
                        ...
                        Taskcolony as a result of this agreement or use of the Site. Taskcolony's performance of this agreement is
                        subject to existing laws and legal process, and nothing contained in this agreement is in derogation of
                        Taskcolony's right to comply with governmental, court and law enforcement requests or requirements
                        relating to your use of the Site or information provided to or gathered by Taskcolony with respect to such
                    ...
                    <p>
                        ...
                        Taskcolony with respect to the Site and it supersedes all prior or contemporaneous communications and
                        proposals, whether electronic, oral or written, between the user and Taskcolony with respect to the Site. A
                ...
                <div className="my-8 ">
                    ...
                    <div className="mt-6">
                        <p className='mb-3'>taskcolony</p>
                        <p className='mb-3'>10780 Westview Drive, STE F</p>
                        <p className='mb-3'>Houston, TX, Texas 77043</p>
                        <p className='mb-3'>Email Address: info@taskcolony.com</p>
                    </div>
                </div>
            </div>
        </Layout>
