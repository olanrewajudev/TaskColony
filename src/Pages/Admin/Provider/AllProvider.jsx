...
import UpdateUser from './UpdateProvider';
import ConfirmDeleteUser from './DeleteProvider';
...
const AllProvider = () => {
    ...
    const fetchUsers = useCallback(async () => {
        ...
        try {
            ...
            // Filter users with kyclevel of 1
            const filteredKycUsers = allUsers.filter(user => user.kyclevel === 1);

            setItems(filteredKycUsers);
            setFilteredItems(filteredKycUsers);
            setTotal(filteredKycUsers.length);
        } catch (err) {
            ...
            <div className="md:mx-10 mx-2 mb-20">
                <div className="bg-white mt-10 px-5 py-4 w-full">
                    <div className="flex items-center justify-between">
                        <div className="font-medium text-lg">All Provider</div>
